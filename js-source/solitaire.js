...
Y.Solitaire.Stack = {
		...
		imageSrc: function () {
			...
			return basename ? Card.base.theme + "/" + basename : "trans.gif";
		},

		layout: function (layout) {
			var hoffset = layout.hoffset * Card.width,
			    voffset = layout.voffset * Card.height,
